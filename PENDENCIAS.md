...
| 2.5 | **Instalar o plugin `plataforma` no whatsbot-pro** e criar o canal lá | você | Os dois lados da ponte estão escritos e testados (41 checagens aqui, 126 no plugin), mas nunca conversaram: falta gerar o `.zip` do plugin, instalá-lo na instância do whatsbot e criar o canal apontando para esta API. |
